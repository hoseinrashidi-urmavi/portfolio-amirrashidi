          ...
          className=" grid grid-cols-1 sm:grid-cols-3 gap-6 mx-w-2xl">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              ...
              whileInView={{ scale: 1.05 }}
                className="border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0_#000] dark:border-white dark:hover:shadow-white dark:hover:bg-black/50"
                key={index}
              >
